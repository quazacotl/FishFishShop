...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./../../../frontend/node_modules/webpack-stream/node_modules/webpack/buildin/global.js */ "./node_modules/webpack-stream/node_modules/webpack/buildin/global.js")))
...
/* harmony import */ var _node_modules_hero_carousel_index__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../node_modules/hero-carousel/index */ "./node_modules/hero-carousel/index.js");
/* harmony import */ var _modules_changePicture__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/changePicture */ "./js/modules/changePicture.js");
...
/* harmony import */ var _modules_hideHeader__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/hideHeader */ "./js/modules/hideHeader.js");
...
/* harmony import */ var _modules_instafeed__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/instafeed */ "./js/modules/instafeed.js");
/* harmony import */ var _modules_instafeed__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_modules_instafeed__WEBPACK_IMPORTED_MODULE_6__);
...
var catalogue = document.querySelector('.header__menu :first-child');
var dropdown = document.querySelector('.dropdown');
var catDrop = [catalogue, dropdown];
catDrop.forEach(function (item) {
...
new _node_modules_hero_carousel_index__WEBPACK_IMPORTED_MODULE_1__["default"](document.querySelector(".carousel"), 5000);
Object(_modules_changePicture__WEBPACK_IMPORTED_MODULE_2__["default"])('.category__item_img-wrapper', '.category__item_img');
Object(_modules_hideHeader__WEBPACK_IMPORTED_MODULE_4__["default"])('header');
Object(_modules_smoothScroll__WEBPACK_IMPORTED_MODULE_5__["default"])('header__menu_link');
Object(_modules_smoothScroll__WEBPACK_IMPORTED_MODULE_5__["default"])('arrow-top');

/***/ }),

/***/ "./js/modules/changePicture.js":
/*!*************************************!*\
  !*** ./js/modules/changePicture.js ***!
  \*************************************/
...
var changePicture = function changePicture(pictureClass, origImgClass) {
  var images = document.querySelectorAll(pictureClass);
  var origImages = document.querySelectorAll(origImgClass);
  images.forEach(function (image) {
    image.addEventListener('pointerenter', function () {
      var sourceHtml = image.querySelector('source').outerHTML;

      if (sourceHtml.slice(-8) === '1.webp">') {
        image.querySelector('source').outerHTML = "".concat(sourceHtml.slice(0, -8), "2.webp\">");
      }
    });
  });
  origImages.forEach(function (image) {
    image.addEventListener('pointerenter', function () {
      var source = image.getAttribute('src');

      if (source.slice(-5) === '1.jpg') {
        image.setAttribute('src', "".concat(source.slice(0, -5), "2.jpg"));
      }
    });
  });
  images.forEach(function (image) {
    image.addEventListener('pointerleave', function () {
      ...
      if (sourceHtml.slice(-8) === '2.webp">') {
        image.querySelector('source').outerHTML = "".concat(sourceHtml.slice(0, -8), "1.webp\">");
      }
    });
  });
  origImages.forEach(function (image) {
    image.addEventListener('pointerleave', function () {
      ...
      if (source.slice(-5) === '2.jpg') {
        image.setAttribute('src', "".concat(source.slice(0, -5), "1.jpg"));
      }
    });
  });
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var hideHeader = function hideHeader(headerClass) {
  var header = document.querySelector(".".concat(headerClass));
  var prevPYO = pageYOffset;
  window.addEventListener('scroll', function () {
    var currPYO = pageYOffset;
...
var instaFeed = function instaFeed(items, itemsPerRow, imageSize, isDisplayCaption) {
  new InstagramFeed({
...
ymaps.ready(function () {
  ...
  var shop_map = new ymaps.Map("map", {
    center: [55.743475, 37.626731],
    zoom: 16,
    controls: ['zoomControl']
  });
  shop_map.behaviors.disable(["scrollZoom", "dblClickZoom"]);
  var myPlacemark = new ymaps.Placemark([55.743326, 37.629717], {
    iconContent: 'Мы здесь'
  }, {
    preset: 'islands#orangeStretchyIcon'
  });
  shop_map.geoObjects.add(myPlacemark); // shop_map.balloon.open(shop_map.getCenter(), {
...
var smoothScroll = function smoothScroll(bntSelector) {
  var btns = document.querySelectorAll(".".concat(bntSelector));
  btns.forEach(function (btn) {
    btn.addEventListener('click', function (e) {
      e.preventDefault();
      var selector = btn.getAttribute('data-linkto');
